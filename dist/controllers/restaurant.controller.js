...
var restaurantService_1 = __importDefault(require("../services/restaurantService"));
var restaurant_validation_1 = __importDefault(require("../validations/restaurant.validation"));
...
var createRestaurant = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, location_1, rating, newUser, error, errorMessage, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, name_1 = _a.name, location_1 = _a.location, rating = _a.rating;
                console.log(name_1, location_1, rating);
                return [4 /*yield*/, restaurantService_1.default.createResService(name_1, location_1, rating)];
            case 1:
                newUser = _b.sent();
                return [4 /*yield*/, restaurant_validation_1.default.createResValidation.validate(req.body)];
            case 2:
                error = (_b.sent()).error;
                if (error) {
...
var getAllRestaurants = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, restaurantService_1.default.getAllResService()];
            case 1:
                users = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                id = req.params.id;
                return [4 /*yield*/, restaurantService_1.default.getResByIdService(id)];
            case 1:
                user = _a.sent();
                if (!id) {
...
var updateRestaurant = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, rating, location_2, existingUser, updatedUser, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                id = req.params.id;
                _a = req.body, rating = _a.rating, location_2 = _a.location;
                return [4 /*yield*/, restaurantService_1.default.getResByIdService(id)];
            case 1:
                ...
                return [4 /*yield*/, restaurantService_1.default.updateResService(id, { rating: rating, location: location_2 })];
            case 2:
                updatedUser = _b.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, restaurantService_1.default.deleteResService(id)];
            case 2:
                _a.sent();
