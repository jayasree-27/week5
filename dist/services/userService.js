...
var createUserService = function (name, email, password) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_model_1.default.create({ name: name, email: email, password: password })];
...
var updateUserService = function (id, updateData) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_model_1.default.findByIdAndUpdate(id, updateData, { new: true })];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
